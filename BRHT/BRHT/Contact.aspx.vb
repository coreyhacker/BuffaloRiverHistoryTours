...
Partial Public Class _contact
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        ...
        mail.Subject = "Buffalo River History Tours Website Form"
        Dim strBody As String = "<b>Buffalo River History Tours</b><br />" & strName & "<br />" & strPhone & "<br />" & strEmail & "<br /><br />" & strComments & "<br /><br />User Agent: " & Request.UserAgent & "<br />IP Address: " & Request.UserHostAddress
        mail.Body = strBody
